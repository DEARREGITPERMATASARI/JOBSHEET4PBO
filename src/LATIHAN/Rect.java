 ...
 */
public class Rect {
    //ada 4 varible utama yang menentukan titik sudut persegi panjang
    public int x1,y1,x2,y2;
    
    /**ini adalah costructor utama **/
    ...
    //** costructor dengan panjang dan lebar dimulai dari kordinat 0,0 */
    public Rect (int width, int height) {
        this(0, 0, width,  height);
    }
    
    //** costructor persegi nol. */
    public Rect() {
        this(0, 0, 0, 0);
    }
